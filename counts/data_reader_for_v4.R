...
counts_observed = read_csv(paste(counts_folder, "weekday_counts_by_station_daily_with_sd.csv", sep  =""))
...
counts_observed_1_car = counts_observed %>% select(station = station_zst, 
                                                   ...
                                                   osm_1 = osm_link_1,
                                                   osm_2 = osm_link_2) %>%
  mutate(veh_type = "car", vehicles = pkw, vehicles_sd = pkw_sd )
...
counts_observed_1_truck = counts_observed %>% select(station = station_zst, 
                                                   ...
                                                   osm_1 = osm_link_1,
                                                   osm_2 = osm_link_2) %>%
  mutate(veh_type = "truck", vehicles = lkw, vehicles_sd = lkw_sd )
